...
class PageTests(unittest.TestCase):
    ...
    def test_nested_index_page(self):
        cfg = load_config(docs_dir=self.DOCS_DIR)
        fl = File('sub1/test.md', cfg['docs_dir'], cfg['site_dir'], cfg['use_directory_urls'])
        pg = Page('Foo', fl, cfg)
        pg.parent = 'foo'
    ...
    def test_nested_nonindex_page(self):
        cfg = load_config(docs_dir=self.DOCS_DIR)
        fl = File('sub1/non-test.md', cfg['docs_dir'], cfg['site_dir'], cfg['use_directory_urls'])
        pg = Page('Foo', fl, cfg)
        pg.parent = 'foo'
    ...
    def test_page_ne(self):
        ...
        f2 = File('test.md', cfg['docs_dir'], cfg['site_dir'], cfg['use_directory_urls'])
        pg = Page('Foo', f1, cfg)
        # Different Title
    ...
    def test_nested_page_edit_url(self):
        ...
        expected = [
            'http://github.com/mkdocs/mkdocs/edit/master/docs/sub1/non-test.md',
            'https://github.com/mkdocs/mkdocs/edit/master/docs/sub1/non-test.md',
            None,
            'http://example.com/edit/master/sub1/non-test.md',
            'http://example.com/edit/master/sub1/non-test.md',
            'http://example.com/edit/master/sub1/non-test.md',
            'http://example.com/edit/master/sub1/non-test.md',
            'http://example.com/edit/master/sub1/non-test.md',
            'http://example.com/foo/edit/master/sub1/non-test.md',
            'http://example.com/foo/edit/master/sub1/non-test.md',
            'http://example.com?query=edit/master/sub1/non-test.md',
            'http://example.com/?query=edit/master/sub1/non-test.md',
            'http://example.com#edit/master/sub1/non-test.md',
            'http://example.com/#edit/master/sub1/non-test.md'
        ]
    ...
    def test_nested_page_edit_url_windows(self):
        ...
        for i, c in enumerate(configs):
            c['docs_dir'] = self.DOCS_DIR
            cfg = load_config(**c)
            fl = File('sub1\\non-test.md', cfg['docs_dir'], cfg['site_dir'], cfg['use_directory_urls'])
            pg = Page('Foo', fl, cfg)
            self.assertEqual(pg.url, 'sub1/non-index/')
            self.assertEqual(pg.edit_url, expected[i])
...
class RelativePathExtensionTests(LogTestCase):
    ...
    @mock.patch('io.open', mock.mock_open(read_data='[link](non-test.md)'))
    def test_relative_html_link(self):
        self.assertEqual(
            self.get_rendered_result(['test.md', 'non-test.md']),
            '<p><a href="non-index/">link</a></p>'  # No trailing /
        )

    @mock.patch('io.open', mock.mock_open(read_data='[link](test.md)'))
    def test_relative_html_link_index(self):
        self.assertEqual(
            self.get_rendered_result(['non-test.md', 'test.md']),
            '<p><a href="..">link</a></p>'
        )

    @mock.patch('io.open', mock.mock_open(read_data='[link](sub2/test.md)'))
    def test_relative_html_link_sub_index(self):
        self.assertEqual(
            self.get_rendered_result(['test.md', 'sub2/test.md']),
            '<p><a href="sub2/">link</a></p>'  # No trailing /
        )

    @mock.patch('io.open', mock.mock_open(read_data='[link](sub2/non-test.md)'))
    def test_relative_html_link_sub_page(self):
        self.assertEqual(
            self.get_rendered_result(['test.md', 'sub2/non-test.md']),
    ...
    def test_relative_html_link_parent_index(self):
        self.assertEqual(
            self.get_rendered_result(['sub2/non-test.md', 'test.md']),
            '<p><a href="../..">link</a></p>'
        )

    @mock.patch('io.open', mock.mock_open(read_data='[link](non-test.md#hash)'))
    ...
    @mock.patch('io.open', mock.mock_open(read_data='[link](sub2/test.md#hash)'))
    ...
    @mock.patch('io.open', mock.mock_open(read_data='[link](sub2/non-test.md#hash)'))
    ...
    def test_relative_html_link_hash_only(self):
        self.assertEqual(
            self.get_rendered_result(['test.md']),
    ...
    def test_relative_image_link_from_homepage(self):
        self.assertEqual(
            self.get_rendered_result(['test.md', 'image.png']),
    ...
    def test_relative_image_link_from_subpage(self):
        self.assertEqual(
            self.get_rendered_result(['sub2/non-test.md', 'image.png']),
    ...
    def test_relative_image_link_from_sibling(self):
        self.assertEqual(
            self.get_rendered_result(['non-test.md', 'image.png']),
            '<p><img alt="image" src="../image.png" /></p>'
        )
    ...
    def test_bad_relative_html_link(self):
        ...
        self.assertEqual(
            cm.output,
            ["WARNING:mkdocs.structure.pages:Documentation file 'test.md' contains a link "
             "to 'non-existant.md' which is not found in the documentation files."]
        )

    @mock.patch('io.open', mock.mock_open(read_data='[external link](http://example.com/test.md)'))
    def test_external_link(self):
        self.assertEqual(
            self.get_rendered_result(['test.md']),
            '<p><a href="http://example.com/test.md">external link</a></p>'
        )
