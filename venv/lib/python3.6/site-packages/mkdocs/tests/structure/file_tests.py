...
class TestFiles(PathAssertionMixin, unittest.TestCase):
    ...
    def test_sort_files(self):
        self.assertEqual(
            _sort_files(['b.md', 'bb.md', 'a.md', 'test.md', 'aa.md']),
            ['test.md', 'a.md', 'aa.md', 'b.md', 'bb.md']
        )

        self.assertEqual(
            _sort_files(['b.md', 'index.html', 'a.md', 'test.md']),
            ['index.html', 'test.md', 'a.md', 'b.md']
        )

        self.assertEqual(
            _sort_files(['a.md', 'test.md', 'b.md', 'index.html']),
            ['test.md', 'index.html', 'a.md', 'b.md']
        )

        self.assertEqual(
            _sort_files(['.md', '_.md', 'a.md', 'test.md', '1.md']),
            ['test.md', '.md', '1.md', '_.md', 'a.md']
        )
    ...
    def test_md_index_file(self):
        f = File('test.md', '/path/to/docs', '/path/to/site', use_directory_urls=False)
        self.assertPathsEqual(f.src_path, 'test.md')
        self.assertPathsEqual(f.abs_src_path, '/path/to/docs/test.md')
    ...
    def test_md_index_file_use_directory_urls(self):
        f = File('test.md', '/path/to/docs', '/path/to/site', use_directory_urls=True)
        self.assertPathsEqual(f.src_path, 'test.md')
        self.assertPathsEqual(f.abs_src_path, '/path/to/docs/test.md')
        self.assertPathsEqual(f.dest_path, 'index.html')
        self.assertPathsEqual(f.abs_dest_path, '/path/to/site/index.html')
    ...
    def test_md_index_file_nested(self):
        f = File('foo/test.md', '/path/to/docs', '/path/to/site', use_directory_urls=False)
        self.assertPathsEqual(f.src_path, 'foo/test.md')
        self.assertPathsEqual(f.abs_src_path, '/path/to/docs/foo/test.md')
        self.assertPathsEqual(f.dest_path, 'foo/index.html')
        self.assertPathsEqual(f.abs_dest_path, '/path/to/site/foo/index.html')
    ...
    def test_md_index_file_nested_use_directory_urls(self):
        f = File('foo/test.md', '/path/to/docs', '/path/to/site', use_directory_urls=True)
        self.assertPathsEqual(f.src_path, 'foo/test.md')
        self.assertPathsEqual(f.abs_src_path, '/path/to/docs/foo/test.md')
        self.assertPathsEqual(f.dest_path, 'foo/index.html')
        self.assertPathsEqual(f.abs_dest_path, '/path/to/site/foo/index.html')
    ...
    def test_files(self):
        fs = [
            File('test.md', '/path/to/docs', '/path/to/site', use_directory_urls=True),
    ...
    def test_get_files(self, tdir):
        ...
        expected = ['test.md', 'bar.css', 'bar.html', 'bar.jpg', 'bar.js', 'bar.md']
